# =============================================================================
# LEGAL-SUITE - Glavni ulaz (entry point)
...
st.set_page_config(page_title="LEGAL-SUITE", page_icon=":scroll:", layout="wide")
...
def _render_pocetna():
    ...
    st.markdown(
        ...
        "position:relative;z-index:1;'>LEGAL-SUITE</p>"
