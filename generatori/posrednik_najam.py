...
def generiraj_ugovor_upravljanje_bc(davatelj, narucitelj, kapacitet, podaci):
    ...
    try:
        ...
        parts.append(
            ...
            f"postupku mirenja iz članka 19. ovog Ugovora."
            f"</div>"
        )
        ...
        parts.append(
            ...
            f"ograničenjima iz članka 354. Zakona o obveznim odnosima."
            f"</div>"
        )
        ...
        parts.append(
            f"<div class='section-title' style='text-align: center;'>Članak 11.</div>"
            f"<div class='justified'>"
            f"(1) Ukoliko prosječna mjesečna popunjenost Baznog kapaciteta "
            f"Radnicima Naručitelja padne ispod 50% u razdoblju duljem od "
            f"60 uzastopnih dana, Davatelj stječe pravo na Re-monetizaciju "
            f"slobodnog kapaciteta.<br><br>"
